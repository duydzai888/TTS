...
- [1. Tốc độ](#toc_do)
- [2. Chi phí triển khai hệ thống](#chi_phi-trien_khai_he_thong)
- [3. Bảo mật](#bao_mat)
...
<a name="chia_se_du_lieu_va_ung_dung"></a>
...
<a name="tac_dong_cua_ung_dung_nguoi_dung_tren_mang"></a>

## III. Tác động của ứng dụng người dùng trên mạng.

<a name="ung_dung_cua_batch"></a>
